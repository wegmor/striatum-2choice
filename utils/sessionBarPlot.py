...
def sessionBarPlot(df, yCol, ax, colorFunc, genotypeCol="genotype", animalCol="animal",
                   ...
                   genotypeOrder=("oprm1", "d1", "a2a"), barAlpha=0.3):
    ...
    ax.bar((0,1,2), genotypeMeans, 0.9, color=barColors, alpha=barAlpha, yerr=genotypeSEMs)
    ...
    genotypeIndex = pd.Series((0,1,2), genotypeOrder).reindex(perAnimal[genotypeCol])
