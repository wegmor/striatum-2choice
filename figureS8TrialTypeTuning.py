...
#%%
svgName = 'figureS8TrialTypeTuning.svg'
...
#                lw=2, alpha=.8)
    ...
    ax.axvline(0, ls=':', color='k', alpha=1, lw=mpl.rcParams['axes.linewidth'], zorder=-99)
    ax.set_ylim((0,4))
...
for genotype in ['d1','a2a','oprm1']:
    for (side, df) in zip(('L','R'), (lt_avg_trial.loc[genotype,[0,1,2]], rt_avg_trial.loc[genotype,[0,1,2]])):
        ...
        ax.axhline(0, ls=':', zorder=-99, c='k', alpha=1, lw=mpl.rcParams['axes.linewidth'])
        ax.axvline(.5, ls=':', zorder=-99, c='k', alpha=1, lw=mpl.rcParams['axes.linewidth'])
...
for genotype in ['d1','a2a','oprm1']:
    for (side, df) in zip(('L','R'), (lt_avg_frame.loc[genotype], rt_avg_frame.loc[genotype])):
        ...
        ax.axvline(-.5, ls=':', c='k', alpha=1, lw=mpl.rcParams['axes.linewidth'], zorder=-99)
        ax.axvline(6.5, ls=':', c='k', alpha=1, lw=mpl.rcParams['axes.linewidth'], zorder=-99)
        ax.axhline(0, ls=':', c='k', alpha=1, lw=mpl.rcParams['axes.linewidth'], zorder=-99)
